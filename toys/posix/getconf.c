...
#define _CS_V7_ENV -1
#endif
// macOS and musl both don't have any of these; same argument as above.
#ifndef _SC_LEVEL1_ICACHE_SIZE
#define _SC_LEVEL1_ICACHE_SIZE -1
#define _SC_LEVEL1_ICACHE_ASSOC -1
#define _SC_LEVEL1_ICACHE_LINESIZE -1
#define _SC_LEVEL1_DCACHE_SIZE -1
#define _SC_LEVEL1_DCACHE_ASSOC -1
#define _SC_LEVEL1_DCACHE_LINESIZE -1
#define _SC_LEVEL2_CACHE_SIZE -1
#define _SC_LEVEL2_CACHE_ASSOC -1
#define _SC_LEVEL2_CACHE_LINESIZE -1
#define _SC_LEVEL3_CACHE_SIZE -1
#define _SC_LEVEL3_CACHE_ASSOC -1
#define _SC_LEVEL3_CACHE_LINESIZE -1
#define _SC_LEVEL4_CACHE_SIZE -1
#define _SC_LEVEL4_CACHE_ASSOC -1
#define _SC_LEVEL4_CACHE_LINESIZE -1
#endif
